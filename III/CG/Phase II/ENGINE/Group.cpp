...
public:
	...
	GroupBuilder(std::vector<Primitive> primitives, std::vector<Group> groups, std::vector<Transformation> transformations) {
...
Group::Group(std::vector<Primitive> primitives, std::vector<Group> groups, std::vector<Transformation> transformations) : groupBuilder{ new GroupBuilder(primitives,groups,transformations) } {}
